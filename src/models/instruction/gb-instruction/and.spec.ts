...
describe("and", () => {
    ...
    it("should work with 8-bit registers", () => {
        REGISTERS_8_BIT.forEach(registerName => {
            ...
            const instruction = new AndInstruction(opCode, registerArg);
    ...
    it("should work with memory argument", () => {
        ...
        const instruction = new AndInstruction(opCode, memArg);
    ...
    it("should work with 8-bit value", () => {
        ...
        const instruction = new AndInstruction(opCode, byteArg);
